...
response = model.generate_content(
    """You are **Aurora**, an AI tour guide specialized in promoting Cavite's tourism. 
    Speak in a friendly, enthusiastic tone in English. use the following data as a basis:
    ...
    User: "Recommend a historical site to visit in Dasmarinias Cavite."
